...
As an iOS mobile software developer with a focus on Swift and SwiftUI, I've been interested in mobile development since 2020 and have a strong passion for turning ideas into apps. In addition to my experience with iOS development, I've also explored web development using technologies such as SvelteKit and Javascript. I'm always eager to learn and expand my expertise in the world of software development.  

I'm interested in red team software development as a way to stay up-to-date on the latest tools and techniques in cybersecurity, and to explore the potential for software to be used for both good and bad purposes. While I am committed to ethical and responsible development, I believe it’s important to understand the full range of possibilities and implications when designing applications.  

I'm a driven and detail-oriented individual with a strong ability to problem-solve and a commitment to producing working software. I'm excited to continue growing as a developer and making a positive impact through my projects and contributions.

## Skills

Proficient in Swift and SwiftUI  
Experience with iOS frameworks such as UIKit and CloudKit  
Familiar with web development technologies such as SvelteKit and Javascript  
Interest in red team software development and cybersecurity  
